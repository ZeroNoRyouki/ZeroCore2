...
class SensorGroupPanelBuilder<Reader extends IMachineReader, SensorType extends Enum<SensorType> & ISensorType<Reader>>
    ...
    @Override
    public IBehaviorGroupBuilder<Reader, SensorType> addSensor(SensorType sensor, NonNullSupplier<ISprite> buttonOffSprite,
                                                               NonNullSupplier<ISprite> buttonOnSprite) {
    ...
    public class BehaviorGroupBuilder
        ...
        public BehaviorGroupBuilder(SensorType sensor, NonNullSupplier<ISprite> buttonOffSprite,
                                    NonNullSupplier<ISprite> buttonOnSprite) {
        ...
        public NonNullSupplier<ISprite> getButtonOnSprite() {
            return this._buttonOnSprite;
        }

        public NonNullSupplier<ISprite> getButtonOffSprite() {
        ...
        private void minMaxValidator(NonNullConsumer<ITextComponent> errors, int... values) {
        ...
        private final NonNullSupplier<ISprite> _buttonOffSprite, _buttonOnSprite;
