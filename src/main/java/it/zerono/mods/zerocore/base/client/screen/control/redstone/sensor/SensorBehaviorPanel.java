...
class SensorBehaviorPanel<Reader extends IMachineReader, Writer, SensorType extends Enum<SensorType> & ISensorType<Reader>,
    ...
    private void validateFirstInput(IControlContainer container, Consumer<ITextComponent> errorReport) {
        this._validator.validate(errorReport::accept, this._inputs[0].intValue());
    }

    @SuppressWarnings("DataFlowIssue")
    private void validateAllInputs(IControlContainer container, Consumer<ITextComponent> errorReport) {
