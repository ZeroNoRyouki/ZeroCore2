...
public class AbstractMultiblockMachineContainer<Controller extends AbstractMultiblockMachineController<Controller, V>,
    ...
    public AbstractMultiblockMachineContainer(int ticksBetweenUpdates, ContainerFactory factory,
                                              ContainerType<? extends AbstractMultiblockMachineContainer<Controller, V, T>> type,
                                              int windowId, T tile) {

        super(ticksBetweenUpdates, factory, type, windowId, tile);
        this.ACTIVE = this.createActiveSyncData();
    }

    public AbstractMultiblockMachineContainer(int ticksBetweenUpdates, ContainerFactory factory,
                                              ContainerType<? extends AbstractMultiblockMachineContainer<Controller, V, T>> type,
                                              int windowId, T tile, ServerPlayerEntity player) {

        super(ticksBetweenUpdates, factory, type, windowId, tile, player);
        this.ACTIVE = this.createActiveSyncData();
    }
    ...
    private BooleanData createActiveSyncData() {
        ...
        return BooleanData.of(this, tile.getPartWorldOrFail().isClientSide(), () -> tile::isMachineActive);
    }
