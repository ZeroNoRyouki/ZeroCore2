...
public class InformationDisplay
    ...
    public InformationDisplay(final ModContainerScreen<? extends ModContainer> gui, final String name,
                              final Consumer<@NotNull ITableLayoutBuilder> builder) {
        super(gui, name, builder);
    }

    public void addInformationCell(final Consumer<@NotNull InformationCellBuilder> builder) {
    ...
    public static class InformationCellBuilder {
        ...
        public InformationCellBuilder icon(Supplier<@NotNull ISprite> sprite) {
        ...
        public InformationCellBuilder tooltips(Consumer<@NotNull BaseScreenToolTipsBuilder> builder) {
        ...
        public InformationCellBuilder layout(final Consumer<@NotNull ITableCellLayoutBuilder> layoutBuilder) {
        ...
        protected Supplier<@NotNull ISprite> _iconSprite;
        protected Consumer<@NotNull Label> _labelTextConfig;
        protected List<Component> _tooltipsLines;
        protected List<Object> _tooltipsObjects;
        @Nullable
        protected IControl _tooltipsSource;
        protected Consumer<@NotNull ITableCellLayoutBuilder> _layoutBuilder;
