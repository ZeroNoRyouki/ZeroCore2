...
class SensorsList<Reader extends IMachineReader, Writer, SensorType extends Enum<SensorType> & ISensorType<Reader>,
    ...
    public SensorsList(SensorGroupPanelBuilder<Reader, SensorType> builder, int columns, String sensorsListLabelKey,
                       Consumer<@NotNull SensorType> onSensorChangedCallback) {
    ...
    private static final Component DIRECTION_INPUT = TextHelper.translatable("gui.zerocore.base.redstone.sensortype.input", ClientBaseHelper::formatAsInfo);
    private static final Component DIRECTION_OUTPUT = TextHelper.translatable("gui.zerocore.base.redstone.sensortype.output", ClientBaseHelper::formatAsInfo);
    private static final int HORIZONTAL_MARGIN = 3;
    private static final int CONTROL_SPACING = 4;
    private final Consumer<@NotNull SensorType> _onSensorChangedCallback;
