...
public class Crafting
    ...
    public void onVariablesAvailable(UnaryOperator<IVariable> lookup, HolderLookup.Provider registries) {
        ...
        final String title1 = lookup.apply(IVariable.wrap(this.title1, registries)).asString();
        final String title2 = lookup.apply(IVariable.wrap(this.title2, registries)).asString();
