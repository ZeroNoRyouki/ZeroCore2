...
public abstract class AbstractManyToOneRecipe<Ingredient, Result,
    ...
    RecipeSerializer<Recipe> createSerializer(String ingredientsFieldName,
        ...
        final MapCodec<Recipe> codec = RecordCodecBuilder.mapCodec(instance ->
                instance.group(
                        ingredientsCodecs.listField(ingredientsFieldName, AbstractManyToOneRecipe::getRecipeIngredients),
                        resultCodecs.field(resultFieldName, AbstractManyToOneRecipe::getResult)
                ).apply(instance, recipeFactory));

        final StreamCodec<RegistryFriendlyByteBuf, Recipe> streamCodec = StreamCodec.composite(
                ingredientsCodecs.listStreamCodec(), AbstractManyToOneRecipe::getRecipeIngredients,
                resultCodecs.streamCodec(), AbstractManyToOneRecipe::getResult,
                recipeFactory
        );
