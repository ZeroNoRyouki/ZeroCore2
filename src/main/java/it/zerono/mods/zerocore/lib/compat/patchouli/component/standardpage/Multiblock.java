...
public class Multiblock
    ...
    public void onVariablesAvailable(UnaryOperator<IVariable> lookup, HolderLookup.Provider registries) {
        ...
        this.multiblockId = lookup.apply(IVariable.wrap(multiblockId, registries)).asString();
    }
    ...
    public void build(final BookContentsBuilder builder, final BookPage page, final BookEntry entry, final int pageNum) {
        ...
        if (multiblockId != null) {
            IMultiblock mb = MultiblockRegistry.MULTIBLOCKS.get(ResourceLocation.tryParse(multiblockId));
    ...
    private void renderMultiblock(final GuiGraphics graphics) {
