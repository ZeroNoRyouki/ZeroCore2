...
public abstract class AbstractStackHolder<Holder extends AbstractStackHolder<Holder, Stack>, Stack>
    ...
    protected <StackType, ContentType> void syncFrom(final CompoundNBT data, final IStackAdapter<StackType, ContentType> adapter,
    ...
    protected <StackType, ContentType> CompoundNBT syncTo(final CompoundNBT data, final List<StackType> items,
