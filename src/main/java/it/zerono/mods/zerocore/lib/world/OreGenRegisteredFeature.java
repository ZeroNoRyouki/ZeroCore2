...
public class OreGenRegisteredFeature
    extends AbstractWorldGenRegisteredFeature<OreGenRegisteredFeature> {
    ...
    protected OreGenRegisteredFeature(final String name, final NonNullFunction<String, ResourceLocation> idFactory,
        ...
        super(name, idFactory, featureSupplier.get().configured(new OreConfiguration(matchRule, oreBlock.get().defaultBlockState(), oresPerCluster)));
    }
