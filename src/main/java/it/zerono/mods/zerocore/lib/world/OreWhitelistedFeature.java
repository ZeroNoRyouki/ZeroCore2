...
//public class OreWhitelistedFeature extends Feature<OreWhitelistedConfig> {
//
//    public static final OreWhitelistedFeature INSTANCE = new OreWhitelistedFeature();
//
//    public boolean place(final IWorld world, final ChunkGenerator<? extends GenerationSettings> chunkGenerator,
//                         final Random random, final BlockPos pos, final OreWhitelistedConfig config) {
//
//        if (!config.shouldGenerateIn(world)) {
//            return false;
//        }
//
//        return placeInternal(world, chunkGenerator, random, pos, config);
//    }
//
//    //region internals
//
//    private static boolean placeInternal(IWorld world, ChunkGenerator<? extends GenerationSettings> generator,
//                                           Random random, BlockPos pos, OreWhitelistedConfig config) {
//
...
//            float f = (float)j / (float)config.getSize();
...
//        }
//
//        for(int l2 = 0; l2 < config.getSize() - 1; ++l2) {
//            if (!(adouble[l2 * 4 + 3] <= 0.0D)) {
//                for(int j3 = l2 + 1; j3 < config.getSize(); ++j3) {
...
//        }
//
//        for(int i3 = 0; i3 < config.getSize(); ++i3) {
...
//                                            if (config.test(world.getBlockState(blockpos$mutableblockpos))) {
//                                                world.setBlockState(blockpos$mutableblockpos, config.getReplacement(), 2);
//                                                ++i;
//                                            }
//                                        }
//                                    }
...
//    }
//
//    private OreWhitelistedFeature() {
//        super(OreWhitelistedConfig::deserialize);
//    }
//}
