...
public class ProgressBarDrawable
    ...
    public static ProgressBarDrawable empty() {
        return new ProgressBarDrawable(() -> Sprite.EMPTY, 0, Padding.ZERO, 0, 0, Orientation.BottomToTop) {
            ...
            @Override
            public void draw(final MatrixStack matrix, final int xOffset, final int yOffset) {
            }

            @Override
            public void draw(final MatrixStack matrix, final int xOffset, final int yOffset, final int maskTop,
