...
public class ItemStackData
    ...
    public static ItemStackData sampled(int frequency, ModContainer container, boolean isClientSide,
                                        Supplier<@NotNull Supplier<ItemStack>> serverSideGetter) {
    ...
    private ItemStackData(Supplier<@NotNull Supplier<ItemStack>> serverSideGetter) {
