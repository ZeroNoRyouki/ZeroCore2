...
public class Table
    ...
    public void addCellContent(final IControl content, final Consumer<@NotNull ITableCellLayoutBuilder> cellBuilder) {
    ...
    public void addEmptyCell(final Consumer<@NotNull ITableCellLayoutBuilder> cellBuilder) {
