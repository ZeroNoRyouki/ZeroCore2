...
public abstract class BindableText
        implements NonNullSupplier<ITextComponent> {

    public static <T> NonNullSupplier<ITextComponent> of(IBindableData<T> bindableData,
    ...
    public static <T> NonNullSupplier<ITextComponent> of(IBindableData<T> bindableData, @Nullable T initialValue,
                                                         Function<T, IFormattableTextComponent> textFactory) {
    ...
    public static <T> NonNullSupplier<ITextComponent> of(IBindableData<T> bindableData, @Nullable T initialValue,
                                                         Function<T, IFormattableTextComponent> textFactory,
                                                         NonNullFunction<IFormattableTextComponent, IFormattableTextComponent> postProcessor) {
    ...
    public static <T, U> NonNullSupplier<ITextComponent> of(IBindableData<T> firstBindableData, IBindableData<U> secondBindableData,
    ...
    public static <T, U> NonNullSupplier<ITextComponent> of(IBindableData<T> firstBindableData, @Nullable T firstInitialValue,
    ...
    @Nullable
    protected abstract IFormattableTextComponent build();

    protected void reset() {
        this._cachedText = null;
    }

    //region NonNullSupplier<ITextComponent>
    ...
    public ITextComponent get() {
        ...
        if (null == this._cachedText) {
            ...
            final IFormattableTextComponent text = this.build();
    ...
    private static class SingleBindableText<T>
        ...
        protected SingleBindableText(@Nullable T initialValue, Function<T, IFormattableTextComponent> textFactory,
                                     NonNullFunction<IFormattableTextComponent, IFormattableTextComponent> postProcessor) {
        ...
        @Nullable
        @Override
        protected IFormattableTextComponent build() {
        ...
        private final Function<T, IFormattableTextComponent> _textFactory;
        @Nullable
    ...
    private static class BiBindableText<T, U>
        ...
        private final BiFunction<T, U, IFormattableTextComponent> _textFactory;
        @Nullable
    ...
    protected BindableText(NonNullFunction<IFormattableTextComponent, IFormattableTextComponent> postProcessor) {
        this._postProcessor = Preconditions.checkNotNull(postProcessor, "Post processor must not be null.");
    }

    protected final NonNullFunction<IFormattableTextComponent, IFormattableTextComponent> _postProcessor;
    protected ITextComponent _cachedText;
