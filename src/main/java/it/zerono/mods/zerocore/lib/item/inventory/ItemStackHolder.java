...
public class ItemStackHolder
     ...
     * </p>
     * Note: This behaviour is subtly different from {@link net.neoforged.neoforge.fluids.capability.IFluidHandler#fill(FluidStack, IFluidHandler.FluidAction)}  fill(FluidStack, boolean)}
     *
