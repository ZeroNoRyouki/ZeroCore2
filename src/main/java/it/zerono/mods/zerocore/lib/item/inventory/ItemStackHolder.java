...
public class ItemStackHolder
    ...
    /**
     * <p>
     * This function re-implements the vanilla function {@link net.minecraft.inventory.IInventory#canPlaceItem(int, ItemStack)}.
    ...
    //endregion
    //region INBTSerializable<CompoundNBT>

    @Override
    public CompoundNBT serializeNBT() {
        return this.syncDataTo(new CompoundNBT(), SyncReason.FullSync);
    }
