...
public abstract class AbstractRecipePage<T, PageType extends PageDoubleRecipe<T>>
    ...
    public void onVariablesAvailable(UnaryOperator<IVariable> lookup) {
        ...
        try {
            ...
            recipe1Field.set(this.getPage(), new ResourceLocation(lookup.apply(IVariable.wrap(recipeId)).asString()));
            recipe2Field.set(this.getPage(), new ResourceLocation(lookup.apply(IVariable.wrap(recipe2Id)).asString()));
