...
//        FMLJavaModLoadingContext.get().getModEventBus().addListener(EventPriority.HIGHEST, this::clearItems);
//    }
//
...
//    }
//
//    public void clearItems(final RegisterEvent event) {
//        event.register(ForgeRegistries.Keys.FEATURES, $ -> this._entries.clear());
//    }
//
//    //region internals
//
