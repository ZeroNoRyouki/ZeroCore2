...
public enum BlockFacingsProperty
    ...
    public static final EnumSet<BlockFacingsProperty> ALL_AND_NONE;
    public static final EnumSet<BlockFacingsProperty> FACES;
    public static final EnumSet<BlockFacingsProperty> ANGLES;
    public static final EnumSet<BlockFacingsProperty> OPPOSITES;
    public static final EnumSet<BlockFacingsProperty> CSHAPES;
    public static final EnumSet<BlockFacingsProperty> CORNERS;
    public static final EnumSet<BlockFacingsProperty> MISCELLANEA;
    public static final EnumSet<BlockFacingsProperty> PIPES;
    public static final EnumSet<BlockFacingsProperty> PIPEENDS;
    ...
    public String asVariantString() {
        return this.asVariantString(FACINGS);
    }

    public String asVariantString(final EnumProperty<BlockFacingsProperty> property) {
        return property.getName() + '=' + property.getName(this);
    }
    ...
    BlockFacingsProperty(byte hash) {
