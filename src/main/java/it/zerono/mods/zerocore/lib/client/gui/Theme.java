...
public final class Theme {
    ...
    /**
     * Create a {@code Theme} from the specified JSON {@link Resource} or return the {@code DEFAULT} theme if the theme
     * can't be loaded from the resource.
     *
     * @param resource The {@link Resource} of the json file to parse.
     * @return A new {@code Theme} initialized from the json file or the {@code DEFAULT} theme.
     */
    ...
    private static Theme read(Reader reader) {
        ...
        try (JsonReader jsonReader = new JsonReader(reader)) {
            ...
            final JsonElement root = JsonParser.parseReader(jsonReader);
